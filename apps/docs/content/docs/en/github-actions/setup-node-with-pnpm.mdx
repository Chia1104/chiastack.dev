...
The `setup-node-witg-pnpm` action provides a convenient way to set up Node.js and pnpm in your GitHub Actions workflows with automatic dependency caching.
  ...
  build:
    ...
    steps:
      ...
      - name: Setup Node.js and pnpm
        uses: ./.github/actions/setup-node-witg-pnpm
...
jobs:
  build:
    ...
    steps:
      ...
      - name: Setup Node.js and pnpm
        uses: chia1104/chiastack.dev/.github/actions/setup-node-witg-pnpm@main
...
```yaml
- name: Setup Node.js and pnpm
  uses: chia1104/chiastack.dev/.github/actions/setup-node-witg-pnpm@v1.0.0
```
